...
public class Sql2oReviewDaoTest {
    ...
    public void reviewsAreReturnedInCorrectOrder() throws Exception {
        ...
        Review testThirdReview = new Review("bloody good grub!", "Scotty", 3, testRestaurant.getId());
        ...
        Review testFourthReview = new Review("I prefer home cooking", "Mr Sulu", 1, testRestaurant.getId());
